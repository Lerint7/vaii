...
if ($_REQUEST['submit']) {
        ...
        if($kontrola->nachadzaSa($pripojenie,'post','nazovPostu', $_POST['nazovLCanku']) < 1) {
...
<form method="post" enctype="application/x-www-form-urlencoded">
    ...
    <textarea required name="obsah" maxlength="1000" minlength="50" style="position: absolute;top: 40%;width: 60%;height: 40%;left: 20%; resize: none"> </textarea>
    <br><br>
